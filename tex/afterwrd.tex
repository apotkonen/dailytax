...
\index{afterwords}
\label{afterwords}
Child's right is to have possibility to have childcare - infant school education,
therefore basic daycare costs should be integrated to child's own support
as well child's part from homing benefit has to be integrated to child's own benefit.
...
Therefore, there has to be legal mechanism to limit dept
