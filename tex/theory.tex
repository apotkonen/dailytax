...
I again recall full working automation for basic income \cite{BasicIncomeInit}\cite{A2PalkkaerotIlta}
...
needing basic support and have this kind of situation after each hickup in
system\cite{KelaSystemUpdates}.
...
mostly this arrogant persons fault. How/Why?

We can take practical example case; people without email and cellular phone
...
%Person who is so bysy to change hes/her 1.5 year old car to newer and bigger
%as status from hes/her capability used to legitimate hes/her own personall
%billing growth towards the company.
...
implementation\cite{LEX_2019_241} from government and corporate operator
